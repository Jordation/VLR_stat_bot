...
def split_players_picks_rnds(player_in):
    global filterlist, filterlistnum
    returnlist=[]
...
def get_stats(stats_in):
    ...
    for i in range(len(stats_in)):
        ...
        stats.append(list(split_players_picks_rnds(stats_in[i].contents[0:3])))
